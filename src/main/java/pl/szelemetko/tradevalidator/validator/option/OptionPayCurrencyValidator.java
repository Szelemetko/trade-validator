...
@Component
public class OptionPayCurrencyValidator implements TradeValidator {
	...
	public ValidationResult validate(Trade trade, ValidationResult result) {
		...
		if (option.getPayCcy().getCurrency() == null) {
			result.addError(FieldName.PAY_CURRENCY, ErrorMessage.INVALID_CURRENCY);
		}
